...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/98345252/153782318-e33e45e4-ff90-444a-9a19-62f907cddcb6.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>showing problem 1 solution <br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>i put arr as value to iterate and have the value show with<br>space in between <br>I checked if the value is divisible by 2 or<br>not, if the reminder is 0 then the value is even otherwise its<br>odd, and printed out the odd value by print function follow by space.<br></p><br></td></tr>
</table></td></tr>
...
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>i went through all values one by one and added to the total,<br>and put total += $arr[i] so it adds the one value to the<br>total every time it goes throw one value.<br>i use the round to round<br>the total in 2 decimal places<br></p><br></td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/98345252/153784686-fb493c24-66d4-44e9-a18c-eeee5adaceed.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>showing problem 3 solution <br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>i checked if the variables is greater then 0 if it is then<br>i print them out with space  <br></p><br></td></tr>
</table></td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://msh52-prod.herokuapp.com/M2/problem1.php">https://msh52-prod.herokuapp.com/M2/problem1.php</a> </td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://msh52-prod.herokuapp.com/M2/problem2.php">https://msh52-prod.herokuapp.com/M2/problem2.php</a> </td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://msh52-prod.herokuapp.com/M2/problem3.php">https://msh52-prod.herokuapp.com/M2/problem3.php</a> </td></tr>
