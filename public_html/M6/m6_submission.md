...
<tr><td> <em>Generated: </em> 3/24/2022 7:06:46 PM</td></tr>
<tr><td> <em>Grading Link: </em> <a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-004-S22/hw-html5-canvas-game/grade/msh52" target="_blank">Grading</a></td></tr></table>
...
<tr><td> <em>Response:</em> <p>Arcade Shooter Game<br></p><br></td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://msh52-prod.herokuapp.com/M6/html5.html">https://msh52-prod.herokuapp.com/M6/html5.html</a> </td></tr>
<tr><td> <em>Sub-Task 3: </em> Add the pull request link for this assignment from M6-HTML5-Canvas to dev</td></tr>
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://github.com/Hussain185/IT202-004/pull/37">https://github.com/Hussain185/IT202-004/pull/37</a> </td></tr>
</table></td></tr>
...
<tr><td> <em>Response:</em> <p>the changes I made is giving the player ability to shot the bullet<br>before it gets destroy/hit the wall. and making the bullet size and speed<br>random <br></p><br></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/98345252/160022727-d996be56-8120-4ad7-9ddb-a12a284fe480.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>showing player shooting i can&#39;t capture shooting the bullet before it gets destroy<br><br></p>
</td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/98345252/160022989-fb8658cf-61fb-4654-a651-e9d33ec1a5f7.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>showing the code of bullet being shot before hitting the wall/making the bullet<br>speed and size random <br></p>
</td></tr>
</table></td></tr>
</table></td></tr>
...
<tr><td><table><tr><td> <em>Sub-Task 1: </em> Describe your change/modification</td></tr>
<tr><td> <em>Response:</em> <p>2nd change is making more then one enemies appear on the screen right<br>after the first one comes out, their speed , size and y position<br>is random similar to enemies one.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 2: </em> Screenshot of the change while playing (try your best as some changes may be nearly impossible to capture)</td></tr>
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/98345252/160023378-fa487a7e-383d-4200-92a0-97a4291fbab4.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>showing two enemies on the screen at random position/speed/size<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 3: </em> Screenshot of the relevant lines of code that implement your change (make sure your ucid and the date are shown in comments) In the caption briefly describe/explain how the code snippet works.</td></tr>
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/98345252/160023664-2aeac9f9-6702-4643-ab2e-6b87ae3220df.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>showing the code of making more then one enemy <br></p>
</td></tr>
</table></td></tr>
</table></td></tr>
...
<tr><td> <em>Response:</em> <p>Coding itself was hard to understand, in order to make some changes I<br>had to read the entire file line by line. To understand how every<br>coding is running  and to make the necessary change and where exactly<br>the change needs to happen i went through entire file. Once i understood<br>what was happening it was easy to make the changes i wanted. <br></p><br></td></tr>
</table></td></tr>
<table><tr><td><em>Grading Link: </em><a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-004-S22/hw-html5-canvas-game/grade/msh52" target="_blank">Grading</a></td></tr></table>